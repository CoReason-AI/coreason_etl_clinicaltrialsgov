...
def test_fetch_studies_success(client, requests_mock):
    url = "https://clinicaltrials.gov/api/v2/studies"
    mock_resp = {"studies": [{"protocolSection": {}}], "nextPageToken": "abc"}
...
def test_fetch_studies_pagination(client, requests_mock):
    url = "https://clinicaltrials.gov/api/v2/studies"
    mock_resp = {"studies": []}
...
def test_fetch_studies_query_term(client, requests_mock):
    url = "https://clinicaltrials.gov/api/v2/studies"
    mock_resp = {"studies": []}
...
def test_fetch_studies_retry_429(client, requests_mock):
    url = "https://clinicaltrials.gov/api/v2/studies"
...
def test_fetch_studies_http_failure(client, requests_mock):
    url = "https://clinicaltrials.gov/api/v2/studies"
...
def test_fetch_studies_connection_error(client, requests_mock):
    url = "https://clinicaltrials.gov/api/v2/studies"
...
def test_list_studies(client, requests_mock):
    url = "https://clinicaltrials.gov/api/v2/studies"
